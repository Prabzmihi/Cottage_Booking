...
public class Booking extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getParameter("reqType").toString().equals("doQuery")){
			...
			String param01 = request.getParameter("param04").toString();
			String param02 = request.getParameter("param05").toString();
			String param03 = request.getParameter("param06").toString();
			String param01 = request.getParameter("param07").toString();
			String param02 = request.getParameter("param08").toString();
			String param03 = request.getParameter("param09").toString();
